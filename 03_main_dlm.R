...
#
# CHANGE FROM THE ORIGINAL CODE: predictions are evaluated at 0/50/90 rather
# than 0/10/90, so the 50% series in Figure 2 is estimated directly from the
# model.  Its confidence interval is sqrt(L'VL) at loading 50, which is NOT the
# same as interpolating between the intervals at 0% and 90% - the standard error
# is a square-root quadratic in coverage, not a linear function of it.  No
