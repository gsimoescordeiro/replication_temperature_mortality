...
# ------------------------------------------------------------------------------
# Appendix F(i), replacement falsification test.
#
# ------------------------------------------------------------------------------
# WHY THE TWO-YEAR LEAD TEST DOES NOT WORK
# ------------------------------------------------------------------------------
# The retired 08_sens_placebo_lead.R replaced coverage with its own two-year lead.  FHS
...
# therefore reproduces the main result whether or not the effect is causal: the
# test has almost no power.
#
# (In the code that produced the submitted manuscript the lead was undefined for
# 2018-19 and those rows were filled with coverage = 0 - the two highest-coverage
# years in the panel, about a tenth of the sample, recoded as "no FHS".  That
# measurement error attenuated the placebo interaction toward zero, which is why
# the test appeared to pass.  It passed because the placebo variable was
# corrupted, not because future coverage fails to predict today's heat
# sensitivity.)
#
# ------------------------------------------------------------------------------
# THE TEST RUN HERE
