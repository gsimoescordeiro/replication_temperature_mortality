...
#
# Coefficients are selected by EXACT name, via bin_coef_index() in
# 01_helpers.R.  It matters most here: the percentile labels are "ext_cold",
# "cold", "mild", "hot", "ext_hot", so a pattern match on "cold" also catches
# "ext_cold" and "hot" also catches "ext_hot".  That would report the sum of two
# bins with the standard error of the wrong linear combination - a wrong number
# that looks entirely reasonable.
#
# STRUCTURE: one figure per region, panels = age group, matching the
