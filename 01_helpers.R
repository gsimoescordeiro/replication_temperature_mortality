...
#
# Why one shared file: the eight model scripts in the original code base were
# near-identical copies, and a coefficient-selection bug present in one of them
# was absent from the others.  Sharing the extraction code means the definition
# of "cumulative effect" exists in exactly one place.
# ==============================================================================
