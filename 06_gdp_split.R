...
#
# A GDP split is easy to dismiss as underpowered, so the script writes every
# estimate and interval rather than only the contrasts, letting that judgement
# be checked instead of assumed.  It does not hold uniformly: the Southeast
# above-median group shows a clear gradient.
#
