...
# ------------------------------------------------------------------------------
# A single sentinel file is not enough.  Most steps write one file per region
# and outcome, so a step can be nine-tenths incomplete while the one file a
# sentinel checks is present - and the step would then be skipped for good.
#
