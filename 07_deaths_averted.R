...
# SPECIFICATION
# ------------------------------------------------------------------------------
# The model includes the `date` fixed effect, so it is the same specification as
# the main model and Table 1.  Dropping it here would make the averted-deaths
# figures come from a different model than the one the Methods describe, which
# is the sort of discrepancy nobody notices until a referee recomputes a total.
#
