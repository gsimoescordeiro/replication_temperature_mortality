...
#
# CHANGE FROM THE ORIGINAL SCRIPT: max(pop_total, na.rm = TRUE) returns -Inf for
# a municipality whose population is missing in every year, and -Inf <= 500000
# is TRUE, so those municipalities were silently retained.  The filter below
# requires a finite maximum.
#
